...
[Knowing which statistical test to use](https://statsandr.com/blog/files/overview-statistical-tests-statsandr.pdf) | Great summary of tests, depending on which variables we want to test.
