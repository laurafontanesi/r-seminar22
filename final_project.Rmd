...
- Part 1: Reading, cleaning, and understanding the data (deadline: **27th of May**)
- Part 2: Fitting statistical models to the data and interpret the results (deadline: **3rd of June**)
...
You can find the data at the OSF depository: https://osf.io/8592y/ (only download the `Data` folder).
...
## Part 1.5 Calculate the reward rate (option to do this in Part 2)
